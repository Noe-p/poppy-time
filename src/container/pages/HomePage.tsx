import { H1, Layout, P18 } from '@/components';
...
export function HomePage(): React.JSX.Element {
  ...
  return (
    <Layout isNavClose={scrollY < 100}>
      ...
      <Main>
        <div className="my-10">
          <H1 className="w-full mb-15 md:text-center">
            {' '}
            <Trans i18nKey={t('home.sections.title')} />
          </H1>
        ...
        <CardProject
          ...
          project={{
            ...
            backgroundImage: { url: '/images/home/concert.webP' },
          }}
        />
        <CardProject
          className="mt-10 min-h-150"
